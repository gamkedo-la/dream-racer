...
var Levels = [
    ...
    },
    {
        ...
        name: "Forest Cruise",
        initialTime: 60 * 1000, // 30 seconds
        musicTrackIndex: 4,
        skyTransformFunc: function () {
        ...
        middlegroundTransformFunc: function (position) {
            return { x: Math.floor(position.x / 20), y: 50, scale: undefined }
        },
		getAICars: function () {
                        const cars = [];
            ...
            laneChange1.push(new aiPathPoint(40, Lane.Left, 15, 0.5, 20));
            laneChange1.push(new aiPathPoint(60, Lane.Right, 15, 0.5, 20));
            laneChange1.push(new aiPathPoint(80, Lane.Right, 15, 0.5, 20));
            ...
            laneChange2.push(new aiPathPoint(130, Lane.Left, 10, 0.5, 20));
            laneChange2.push(new aiPathPoint(150, Lane.Right, 10, 0.5, 20));
            laneChange2.push(new aiPathPoint(170, Lane.Left, 15, 0.5, 20));

            const car2 = new AICar(AIType.SportBlue, aiStartPos2, laneChange2);
            cars.push(car2);
            
            const aiStartPos3 = new aiStart(135, Lane.Right, 15, 0.25, 60);
            let laneChange3 = [];
            laneChange3.push(new aiPathPoint(136, Lane.Right, 15, 0.5, 20));
            laneChange3.push(new aiPathPoint(145, Lane.Center, 15, 0.5, 20));
            laneChange3.push(new aiPathPoint(155, Lane.Right, 15, 0.5, 20));
            laneChange3.push(new aiPathPoint(170, Lane.Left, 15, 0.5, 20));
            laneChange3.push(new aiPathPoint(190, Lane.Center, 15, 0.5, 20));

            const car3 = new AICar(AIType.PickupBlack, aiStartPos3, laneChange3);
            cars.push(car3);

            const aiStartPos4 = new aiStart(445, Lane.Right, 15, 0.25, 60);
            let laneChange4 = [];
            laneChange4.push(new aiPathPoint(446, Lane.Right, 15, 0.5, 20));
            laneChange4.push(new aiPathPoint(495, Lane.Center, 15, 0.5, 20));
            laneChange4.push(new aiPathPoint(520, Lane.Right, 10, 0.5, 20));
            laneChange4.push(new aiPathPoint(550, Lane.Center, 10, 0.5, 20));
            laneChange4.push(new aiPathPoint(570, Lane.Left, 15, 0.5, 20));

            const car4 = new AICar(AIType.Semi, aiStartPos4, laneChange4);
            cars.push(car4);


            const aiStartPos5 = new aiStart(895, Lane.Left, 15, 0.25, 90);
            let laneChange5 = [];
            laneChange5.push(new aiPathPoint(896, Lane.Left, 15, 0.5, 20));
            laneChange5.push(new aiPathPoint(905, Lane.Right, 15, 0.5, 20));
            laneChange5.push(new aiPathPoint(910, Lane.Left, 15, 0.5, 20));
            laneChange5.push(new aiPathPoint(930, Lane.Center, 15, 0.5, 20));
            laneChange5.push(new aiPathPoint(975, Lane.Right, 15, 0.5, 20));

            const car5 = new AICar(AIType.PickupBrown, aiStartPos5, laneChange5);
            cars.push(car5);

            const aiStartPos6 = new aiStart(235, Lane.Center, 15, 0.25, 185);
            let laneChange6 = [];
            laneChange6.push(new aiPathPoint(236, Lane.Center, 15, 0.5, 20));
            laneChange6.push(new aiPathPoint(265, Lane.Left, 15, 0.5, 20));
            ...
            const car6 = new AICar(AIType.SportBrown, aiStartPos6, laneChange6);
            cars.push(car6);

            const aiStartPos7 = new aiStart(1195, Lane.Left, 20, 0.25, 145);//aiStart(startInd, startLane, speed, acceleration, playerIndexToStart)
            let laneChange7 = [];
            laneChange7.push(new aiPathPoint(1196, Lane.Left, 20, 0.5, 20));//aiPathPoint(segmentIndex, lane, desiredSpeed, acceleration, laneSpeed) 
            laneChange7.push(new aiPathPoint(1235, Lane.Right, 23, 0.5, 20));
            laneChange7.push(new aiPathPoint(1240, Lane.Center, 23, 0.5, 20));
            laneChange7.push(new aiPathPoint(1280, Lane.Left, 25, 0.5, 20));
            laneChange7.push(new aiPathPoint(1310, Lane.Right, 25, 0.5, 20));

            const car7 = new AICar(AIType.PickupGreen, aiStartPos7, laneChange7);
            cars.push(car7);

            const aiStartPos8 = new aiStart(275, Lane.Center, 15, 0.25, 225);
            let laneChange8 = [];
            laneChange8.push(new aiPathPoint(276, Lane.Center, 15, 0.5, 20));
            laneChange8.push(new aiPathPoint(315, Lane.Left, 15, 0.5, 20));
            ...
            const car8 = new AICar(AIType.SemiBlack, aiStartPos8, laneChange8);
            cars.push(car8);
            
            const aiStartPos9 = new aiStart(205, Lane.Left, 23, 0.25, 165);
            let laneChange9 = [];
            laneChange9.push(new aiPathPoint(236, Lane.Left, 23, 0.5, 20));
            laneChange9.push(new aiPathPoint(255, Lane.Right, 23, 0.5, 20));
            laneChange9.push(new aiPathPoint(270, Lane.Left, 10, 0.5, 20));
            laneChange9.push(new aiPathPoint(280, Lane.Right, 10, 0.5, 20));
            laneChange9.push(new aiPathPoint(300, Lane.Center, 10, 0.5, 20));

            const car9 = new AICar(AIType.PickupPink, aiStartPos9, laneChange9);
            cars.push(car9);

            const aiStartPos10 = new aiStart(2205, Lane.Center, 25, 0.25, 165);
            let laneChange10 = [];
            laneChange10.push(new aiPathPoint(2256, Lane.Center, 25, 0.5, 20));
            laneChange10.push(new aiPathPoint(2285, Lane.Right, 25, 0.5, 20));
            laneChange10.push(new aiPathPoint(2290, Lane.Left, 30, 0.5, 20));
            laneChange10.push(new aiPathPoint(2300, Lane.Center, 30, 0.5, 20));
            laneChange10.push(new aiPathPoint(2350, Lane.Left, 25, 0.5, 20));

            const car10 = new AICar(AIType.SportGreen, aiStartPos10, laneChange10);
            cars.push(car10);

            const aiStartPos11 = new aiStart(285, Lane.Left, 17, 0.25, 235);
            let laneChange11 = [];
            laneChange11.push(new aiPathPoint(286, Lane.Left, 17, 0.5, 20));
            laneChange11.push(new aiPathPoint(295, Lane.Right, 17, 0.5, 20));
            laneChange11.push(new aiPathPoint(320, Lane.Left, 17, 0.5, 20));
            laneChange11.push(new aiPathPoint(340, Lane.Center, 17, 0.5, 20));
            laneChange11.push(new aiPathPoint(380, Lane.Right, 17, 0.5, 20));

            const car11 = new AICar(AIType.PickupRed, aiStartPos11, laneChange11);
            cars.push(car11);

            const aiStartPos12 = new aiStart(295, Lane.Right, 15, 0.25, 245);
            let laneChange12 = [];
            laneChange12.push(new aiPathPoint(296, Lane.Right, 15, 0.5, 20));
            laneChange12.push(new aiPathPoint(325, Lane.Left, 20, 0.5, 20));
            laneChange12.push(new aiPathPoint(350, Lane.Center, 20, 0.5, 20));
            laneChange12.push(new aiPathPoint(370, Lane.Left, 20, 0.5, 20));
            laneChange12.push(new aiPathPoint(380, Lane.Right, 13, 0.5, 20));

            const car12 = new AICar(AIType.SportYellow, aiStartPos12, laneChange12);
            cars.push(car12);
            
            const aiStartPos14 = new aiStart(435, Lane.Right, 15, 0.25, 85);
            let laneChange14 = [];
            laneChange14.push(new aiPathPoint(436, Lane.Right, 15, 0.5, 20));
            laneChange14.push(new aiPathPoint(465, Lane.Center, 15, 0.5, 20));
            laneChange14.push(new aiPathPoint(485, Lane.Center, 10, 0.5, 20));
            laneChange14.push(new aiPathPoint(500, Lane.Right, 10, 0.5, 20));
            laneChange14.push(new aiPathPoint(520, Lane.Left, 15, 0.5, 20));

            const car14 = new AICar(AIType.SportLightBlue, aiStartPos14, laneChange14);
            cars.push(car14);
            
            const aiStartPos15 = new aiStart(685, Lane.Left, 15, 0.25, 230);
            let laneChange15 = [];
            laneChange15.push(new aiPathPoint(686, Lane.Left, 15, 0.5, 20));
            laneChange15.push(new aiPathPoint(695, Lane.Center, 15, 0.5, 20));
            laneChange15.push(new aiPathPoint(710, Lane.Right, 15, 0.5, 20));
            laneChange15.push(new aiPathPoint(725, Lane.Left, 15, 0.5, 20));
            laneChange15.push(new aiPathPoint(740, Lane.Center, 15, 0.5, 20));
            ...
            laneChange16.push(new aiPathPoint(435, Lane.Center, 15, 0.5, 20));
            laneChange16.push(new aiPathPoint(455, Lane.Left, 10, 0.5, 20));
            laneChange16.push(new aiPathPoint(465, Lane.Right, 10, 0.5, 20));
            laneChange16.push(new aiPathPoint(495, Lane.Left, 15, 0.5, 20));

            const car16 = new AICar(AIType.SportGreen, aiStartPos16, laneChange16);
            cars.push(car16);
            ...
            laneChange18.push(new aiPathPoint(705, Lane.Left, 10, 0.5, 20));
            laneChange18.push(new aiPathPoint(725, Lane.Center, 10, 0.5, 20));
            laneChange18.push(new aiPathPoint(760, Lane.Left, 15, 0.5, 20));

            const car18 = new AICar(AIType.SportPurple, aiStartPos18, laneChange18);
            cars.push(car18);

            const aiStartPos19 = new aiStart(695, Lane.Center, 20, 0.25, 640);//aiStart(startInd, startLane, speed, acceleration, playerIndexToStart)
            let laneChange19 = [];
            laneChange19.push(new aiPathPoint(696, Lane.Center, 20, 0.5, 20));//aiPathPoint(segmentIndex, lane, desiredSpeed, acceleration, laneSpeed) 
            laneChange19.push(new aiPathPoint(735, Lane.Right, 23, 0.5, 20));
            laneChange19.push(new aiPathPoint(740, Lane.Left, 23, 0.5, 20));
            ...
            laneChange20.push(new aiPathPoint(860, Lane.Left, 20, 0.5, 20));
            laneChange20.push(new aiPathPoint(880, Lane.Center, 20, 0.5, 20));
            laneChange20.push(new aiPathPoint(900, Lane.Left, 15, 0.5, 20));
            ...
            laneChange21.push(new aiPathPoint(960, Lane.Center, 23, 0.5, 20));
            laneChange21.push(new aiPathPoint(970, Lane.Left, 10, 0.5, 20));
            ...
            laneChange22.push(new aiPathPoint(1085, Lane.Left, 25, 0.5, 20));
            ...
            const car22 = new AICar(AIType.SportSilver, aiStartPos22, laneChange22);
            cars.push(car22);

            const aiStartPos23 = new aiStart(1185, Lane.Center, 17, 0.25, 1130);
            let laneChange23 = [];
            laneChange23.push(new aiPathPoint(1186, Lane.Center, 17, 0.5, 20));
            ...
            laneChange23.push(new aiPathPoint(1280, Lane.Center, 17, 0.5, 20));
            ...
            laneChange24.push(new aiPathPoint(1325, Lane.Left, 20, 0.5, 20));
            laneChange24.push(new aiPathPoint(1350, Lane.Center, 20, 0.5, 20));
            laneChange24.push(new aiPathPoint(1390, Lane.Right, 20, 0.5, 20));
            laneChange24.push(new aiPathPoint(1420, Lane.Left, 13, 0.5, 20));
            ...
            laneChange25.push(new aiPathPoint(1445, Lane.Left, 15, 0.5, 20));
            laneChange25.push(new aiPathPoint(1460, Lane.Center, 15, 0.5, 20));
            laneChange25.push(new aiPathPoint(1480, Lane.Left, 15, 0.5, 20));
            laneChange25.push(new aiPathPoint(1500, Lane.Right, 15, 0.5, 20));

            const car25 = new AICar(AIType.SportLightBlue, aiStartPos25, laneChange25);
            cars.push(car25);
 
            const aiStartPos26 = new aiStart(1535, Lane.Right, 15, 0.25, 1490);
            let laneChange26 = [];
            laneChange26.push(new aiPathPoint(1536, Lane.Right, 15, 0.5, 20));
            laneChange26.push(new aiPathPoint(1565, Lane.Center, 15, 0.5, 20));
            laneChange26.push(new aiPathPoint(1570, Lane.Left, 10, 0.5, 20));
            laneChange26.push(new aiPathPoint(1585, Lane.Right, 10, 0.5, 20));
            laneChange26.push(new aiPathPoint(1610, Lane.Left, 15, 0.5, 20));

            const car26 = new AICar(AIType.SportYellow, aiStartPos26, laneChange26);
            cars.push(car26);
            
            const aiStartPos27 = new aiStart(1685, Lane.Left, 15, 0.25, 1630);
            let laneChange27 = [];
            laneChange27.push(new aiPathPoint(1686, Lane.Left, 15, 0.5, 20));
            laneChange27.push(new aiPathPoint(1695, Lane.Right, 15, 0.5, 20));
            laneChange27.push(new aiPathPoint(1720, Lane.Left, 15, 0.5, 20));
            laneChange27.push(new aiPathPoint(1735, Lane.Center, 15, 0.5, 20));
            laneChange27.push(new aiPathPoint(1770, Lane.Left, 15, 0.5, 20));
            ...
            laneChange28.push(new aiPathPoint(1835, Lane.Left, 15, 0.5, 20));
            laneChange28.push(new aiPathPoint(1845, Lane.Center, 15, 0.5, 20));
            laneChange28.push(new aiPathPoint(1870, Lane.Left, 10, 0.5, 20));
            laneChange28.push(new aiPathPoint(1895, Lane.Center, 10, 0.5, 20));

            const car28 = new AICar(AIType.PickupRed, aiStartPos28, laneChange28);
            cars.push(car28);

            const aiStartPos29 = new aiStart(1925, Lane.Right, 15, 0.25, 1880);
            let laneChange29 = [];
            laneChange29.push(new aiPathPoint(1926, Lane.Right, 15, 0.5, 20));
            laneChange29.push(new aiPathPoint(1935, Lane.Center, 17, 0.5, 20));
            laneChange29.push(new aiPathPoint(1945, Lane.Left, 20, 0.5, 20));
            laneChange29.push(new aiPathPoint(1970, Lane.Right, 23, 0.5, 20));
            laneChange29.push(new aiPathPoint(1995, Lane.Center, 25, 0.5, 20));
            ...
            let laneChange30 = [];
            laneChange30.push(new aiPathPoint(2056, Lane.Center, 15, 0.5, 20));
            laneChange30.push(new aiPathPoint(2085, Lane.Right, 15, 0.5, 20));
            laneChange30.push(new aiPathPoint(2105, Lane.Left, 10, 0.5, 20));
            laneChange30.push(new aiPathPoint(2120, Lane.Center, 10, 0.5, 20));
            ...
            laneChange32.push(new aiPathPoint(2245, Lane.Left, 15, 0.5, 20));
            laneChange32.push(new aiPathPoint(2260, Lane.Center, 20, 0.5, 20));
            laneChange32.push(new aiPathPoint(2280, Lane.Right, 20, 0.5, 20));
            ...
            laneChange33.push(new aiPathPoint(2355, Lane.Center, 23, 0.5, 20));
            laneChange33.push(new aiPathPoint(2370, Lane.Right, 30, 0.5, 20));
            laneChange33.push(new aiPathPoint(2390, Lane.Left, 30, 0.5, 20));
            laneChange33.push(new aiPathPoint(2410, Lane.Right, 30, 0.5, 20));
            ...
            let laneChange34 = [];
            laneChange34.push(new aiPathPoint(2456, Lane.Center, 25, 0.5, 20));
            laneChange34.push(new aiPathPoint(2485, Lane.Right, 25, 0.5, 20));
            laneChange34.push(new aiPathPoint(2490, Lane.Left, 30, 0.5, 20));
            laneChange34.push(new aiPathPoint(2500, Lane.Center, 30, 0.5, 20));
            laneChange34.push(new aiPathPoint(2540, Lane.Right, 25, 0.5, 20));
            ...
            laneChange35.push(new aiPathPoint(2595, Lane.Left, 17, 0.5, 20));
            laneChange35.push(new aiPathPoint(2620, Lane.Center, 23, 0.5, 20));
            laneChange35.push(new aiPathPoint(2640, Lane.Right, 23, 0.5, 20));
            laneChange35.push(new aiPathPoint(2680, Lane.Center, 17, 0.5, 20));
            ...
            laneChange38.push(new aiPathPoint(1275, Lane.Left, 15, 0.5, 20));
            ...
            laneChange39.push(new aiPathPoint(1365, Lane.Right, 15, 0.5, 20));
            laneChange39.push(new aiPathPoint(1380, Lane.Left, 15, 0.5, 20));
            laneChange39.push(new aiPathPoint(1420, Lane.Right, 15, 0.5, 20));
    ...
    },
    {
        ...
        nearHeight: 0.0 * GAME_HEIGHT,
        horizonHeight: 1.0 * GAME_HEIGHT,
        roadReferences: [JSON.parse(frankensteinTrack)],
        near: 90,//arbitrary
        far: 500,//arbitrary
        cameraPos: { x: 0, y: -GAME_HEIGHT / 2, z: -85 },
        groundColor: "#ac7339",
        secondaryGroundColor: "#604020",
        ...
        backgroundTransformFunc: function (position) {
            return { x: Math.floor(position.x / 125), y: 45, scale: undefined }
        },
        middlegroundTransformFunc: function (position) {
            return { x: Math.floor(position.x / 70) - 800, y: 45, scale: (1 + (position.z / 144000)) }
        },
        getAICars: function () {
            const cars = [];
            const aiStartPos3 = new aiStart(285, Lane.Left, 10, 0.25, 230);
            ...
            laneChange3.push(new aiPathPoint(310, Lane.Center, 10, 0.5, 20));
            laneChange3.push(new aiPathPoint(320, Lane.Left, 10, 0.5, 20));
            ...
            const car5 = new AICar(AIType.PickupBlue, aiStartPos5, laneChange5);
            cars.push(car5);

            const aiStartPos6 = new aiStart(655, Lane.Center, 10, 0.25, 600);
            let laneChange6 = [];
            laneChange6.push(new aiPathPoint(656, Lane.Center, 12, 0.5, 20));
            laneChange6.push(new aiPathPoint(685, Lane.Left, 17, 0.5, 20));
            laneChange6.push(new aiPathPoint(705, Lane.Right, 5, 0.5, 20));
            laneChange6.push(new aiPathPoint(720, Lane.Center, 5, 0.5, 20));
            laneChange6.push(new aiPathPoint(750, Lane.Left, 10, 0.5, 20));

            const car6 = new AICar(AIType.SportYellow, aiStartPos6, laneChange6);
            cars.push(car6);
            ...
            laneChange7.push(new aiPathPoint(735, Lane.Center, 18, 0.5, 20));
            laneChange7.push(new aiPathPoint(740, Lane.Right, 18, 0.5, 20));
            laneChange7.push(new aiPathPoint(780, Lane.Center, 20, 0.5, 20));
            laneChange7.push(new aiPathPoint(810, Lane.Left, 20, 0.5, 20));
            ...
            let laneChange9 = [];
            laneChange9.push(new aiPathPoint(936, Lane.Left, 18, 0.5, 20));
            laneChange9.push(new aiPathPoint(960, Lane.Center, 18, 0.5, 20));
            laneChange9.push(new aiPathPoint(970, Lane.Left, 5, 0.5, 20));
            laneChange9.push(new aiPathPoint(990, Lane.Right, 5, 0.5, 20));
            laneChange9.push(new aiPathPoint(1020, Lane.Center, 5, 0.5, 20));
            ...
            const car10 = new AICar(AIType.SportLightBlue, aiStartPos10, laneChange10);
            cars.push(car10);

            const aiStartPos11 = new aiStart(1185, Lane.Left, 12, 0.25, 1130);
            let laneChange11 = [];
            laneChange11.push(new aiPathPoint(1186, Lane.Left, 12, 0.5, 20));
            laneChange11.push(new aiPathPoint(1195, Lane.Center, 15, 0.5, 20));
            laneChange11.push(new aiPathPoint(1220, Lane.Right, 10, 0.5, 20));
            laneChange11.push(new aiPathPoint(1240, Lane.Left, 12, 0.5, 20));
            laneChange11.push(new aiPathPoint(1280, Lane.Right, 12, 0.5, 20));

            const car11 = new AICar(AIType.SemiBlack, aiStartPos11, laneChange11);
            cars.push(car11);
            ...
            laneChange12.push(new aiPathPoint(1370, Lane.Center, 15, 0.5, 20));
            laneChange12.push(new aiPathPoint(1380, Lane.Left, 8, 0.5, 20));

            const car12 = new AICar(AIType.SemiGreen, aiStartPos12, laneChange12);
            cars.push(car12);
            ...
            laneChange13.push(new aiPathPoint(1426, Lane.Right, 10, 0.5, 20));
            laneChange13.push(new aiPathPoint(1435, Lane.Center, 10, 0.5, 20));
            laneChange13.push(new aiPathPoint(1440, Lane.Left, 10, 0.5, 20));
            laneChange13.push(new aiPathPoint(1450, Lane.Right, 10, 0.5, 20));
            laneChange13.push(new aiPathPoint(1460, Lane.Center, 10, 0.5, 20));

            const car13 = new AICar(AIType.SportPurple, aiStartPos13, laneChange13);
            cars.push(car13);
            ...
            laneChange14.push(new aiPathPoint(1565, Lane.Center, 10, 0.5, 20));
            laneChange14.push(new aiPathPoint(1570, Lane.Right, 5, 0.5, 20));
            laneChange14.push(new aiPathPoint(1580, Lane.Center, 5, 0.5, 20));
            laneChange14.push(new aiPathPoint(1590, Lane.Left, 10, 0.5, 20));
            ...
            let laneChange15 = [];
            laneChange15.push(new aiPathPoint(1686, Lane.Left, 10, 0.5, 20));
            laneChange15.push(new aiPathPoint(1695, Lane.Right, 10, 0.5, 20));
            laneChange15.push(new aiPathPoint(1700, Lane.Left, 10, 0.5, 20));
            laneChange15.push(new aiPathPoint(1710, Lane.Right, 10, 0.5, 20));
            laneChange15.push(new aiPathPoint(1720, Lane.Left, 10, 0.5, 20));

            const car15 = new AICar(AIType.SportGreen, aiStartPos15, laneChange15);
            cars.push(car15);

            const aiStartPos16 = new aiStart(1795, Lane.Center, 10, 0.25, 1740);
            let laneChange16 = [];
            laneChange16.push(new aiPathPoint(1806, Lane.Center, 10, 0.5, 20));
            laneChange16.push(new aiPathPoint(1835, Lane.Right, 10, 0.5, 20));
            laneChange16.push(new aiPathPoint(1840, Lane.Left, 10, 0.5, 20));
            laneChange16.push(new aiPathPoint(1850, Lane.Left, 5, 0.5, 20));
            laneChange16.push(new aiPathPoint(1870, Lane.Right, 5, 0.5, 20));
            ...
            let laneChange17 = [];
            laneChange17.push(new aiPathPoint(1926, Lane.Left, 10, 0.5, 20));
            laneChange17.push(new aiPathPoint(1935, Lane.Right, 12, 0.5, 20));
            laneChange17.push(new aiPathPoint(1940, Lane.Center, 15, 0.5, 20));
            laneChange17.push(new aiPathPoint(1950, Lane.Left, 18, 0.5, 20));
            laneChange17.push(new aiPathPoint(1960, Lane.Left, 20, 0.5, 20));

            const car17 = new AICar(AIType.PickupBlack, aiStartPos17, laneChange17);
            cars.push(car17);
            ...
            const car18 = new AICar(AIType.SemiBlue, aiStartPos18, laneChange18);
            cars.push(car18);
            ...
            laneChange19.push(new aiPathPoint(2096, Lane.Right, 15, 0.5, 20));//aiPathPoint(segmentIndex, lane, desiredSpeed, acceleration, laneSpeed) 
            laneChange19.push(new aiPathPoint(2135, Lane.Center, 18, 0.5, 20));
            laneChange19.push(new aiPathPoint(2140, Lane.Center, 8, 0.5, 20));
            laneChange19.push(new aiPathPoint(2180, Lane.Right, 20, 0.5, 20));
            laneChange19.push(new aiPathPoint(2210, Lane.Left, 20, 0.5, 20));

            const car19 = new AICar(AIType.PickupPink, aiStartPos19, laneChange19);
            cars.push(car19);
